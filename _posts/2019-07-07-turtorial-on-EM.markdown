...
![EM initialization](https://nianlonggu.github.io/img/2019-07-07-EM/exaple-em-init.svg)
As shown in this figure, if the initialization is at point A, then EM will converge at point $$$$